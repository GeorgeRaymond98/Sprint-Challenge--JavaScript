...
const dinosaurOne = new Dinosaurs({
  name: 'tyrannosaurus',
  diet: 'carnivorous',
  weight: 7000 + 'kg',
  length: 12 + 'm',
...
const dinosaurTwo = new Dinosaurs({
  name: 'stegosaurus',
  diet: 'herbivorous',
  weight: 2000 + 'kg',
  length: 9 + 'm',
...
const dinosaurThree = new Dinosaurs({
  name: 'Velociraptor',
  diet: 'carnivorous',
  weight: 15 + 'kg',
  length: 12 + 'm',
...
zooAnimals.forEach(function(name){
  return displayNames.push(`Name:${name.animal_name}, Scientific Name: ${name.scientific_name}`);
});
...
lowCaseAnimalNames = zooAnimals.map(function(lowname){ 
...
lowPopulationAnimals = zooAnimals.filter(function(dead){
 return dead.population < 5;
});
